...
@section('breadcrumb')
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{ route('patient.notification') }}">Notification</a>
          </li>
                    ...
                    <nav aria-label="..." style="float: right;">
                      <ul class="pagination">
                        @if ($prescription->prescription_id-1 > 0)
                          {{-- expr --}}
                        <li class="page-item">
                          <a class="page-link" href="{{route('patient.notification.single', [$prescription->prescription_id-1])}}">Previous</a>
                        </li>
                        @endif
                        ...
                        <li class="page-item">
                          <a class="page-link" href="{{route('patient.notification.single', [$prescription->prescription_id+1])}}">Next</a>
                        </li>
                        @endif
                      </ul>
                    </nav>
